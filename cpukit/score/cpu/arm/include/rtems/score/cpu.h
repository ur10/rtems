...
#define CPU_MAXIMUM_PROCESSORS 32
  ...
  #define ARM_CONTEXT_CONTROL_THREAD_ID_OFFSET 44
    ...
    #define ARM_CONTEXT_CONTROL_STACK_ATTR_OFFSET_PROT_ATTR_OFFSET   112
  #elif ARM_MULTILIB_HAS_THREAD_ID_REGISTER
    #define ARM_CONTEXT_CONTROL_STACK_ATTR_OFFSET_PROT_ATTR_OFFSET  48
  #else 
    #define ARM_CONTEXT_CONTROL_STACK_ATTR_OFFSET_PROT_ATTR_OFFSET  44
  #endif 
#endif
